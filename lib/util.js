...
export default {
	...
	getRightArr(date) {
		...
		let rightNum = 7 - leftLength % 7; //计算后面还需要补的天数
		if (leftLength < 35) {
			rightNum += 7; //不足6行数据，补足6行
		}
